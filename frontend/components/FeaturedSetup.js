    ...
    <Grid container spacing={3}>
      <Grid item xs={12}>
        <Paper className={classes.paper}>
          ...
          <Typography style={{ paddingTop: 20 }} className={classes.label} variant="body2">Featured setup from <Link href={"user/michaelfromyeg"}><a>@michaelfromyeg</a></Link></Typography>
        </Paper>
      </Grid>
    </Grid>
  )
